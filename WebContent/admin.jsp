...
<head>
<meta charset="utf-8">
<title>Continuous delivery and Integration - Admin</title>
...
<body>
	<div class="wrap">
		<form action="UserController" id="adminform" method="post">
		<h1>${message}!!</h1><br><br>
			<nav class="menu">
				<ul>
					<li><a href="#">Home</a></li>
					<li><a href="javascript:;" onclick="document.getElementById('adminform').submit();">Manage users</a></li>
				</ul>
			</nav>
